...
const Word = memo(function Word({
    ...
    return (
        <motion.div
            className={cn(
                "flex gap-[0.1em] text-2xl sm:text-4xl md:text-7xl font-bold uppercase tracking-wider text-neutral-800 dark:text-zinc-800",
                textClassName
            )}
            initial="initial"
            animate="animate"
...
export function FlipFadeText({
    ...
    return (
        <div className={cn("flex items-center justify-center -mt-20 md:-mt-150 lg:-mt-160", className)}>
